/**
 * ACME Financial Small Business Product Catalog
 * Source: acmefinancial.com/small-business — assessed March 23, 2026
 *
...
const ACME_SB_PRODUCTS = {

  checking: [
    {
      id: 'simple-checking',
      name: 'ACME Financial Business Starter Checking',
      category: 'checking',
      ...
      applyUrl: 'https://businessdeposits.digitalcommerce.acmefinancial.com/product/110',
    },
    {
      id: 'dynamic-checking',
      name: 'ACME Financial Business Advantage Checking',
      category: 'checking',
      ...
      applyUrl: 'https://businessdeposits.digitalcommerce.acmefinancial.com/product/169',
    },
  ],
  ...
  savings: [
    {
      id: 'simple-savings',
      name: 'ACME Financial Business Savings Account',
      category: 'savings',
      ...
      features: [
        ...
        'Can be paired with Business Advantage Checking for relationship tier benefits',
      ],
    ...
    {
      id: 'money-market',
      name: 'ACME Financial Business Premier Savings',
      category: 'savings',
    ...
    {
      id: 'business-cds',
      name: 'ACME Financial Business Growth CDs',
      category: 'savings',
  ...
  credit_cards: [
    {
      ...
      name: 'ACME Financial Business Rewards Card',
      ...
      applyUrl: 'https://businesscreditcard.digitalcommerce.acmefinancial.com/product/SBC',
    },
    {
      id: 'premium-card',
      name: 'ACME Financial Business Elite Card',
      category: 'credit_cards',
      tagline: 'Premium rewards card with a 10% Loyalty Cash Bonus when redeemed to a ACME Financial deposit account.',
      features: [
        '$299 annual fee (waived year 1; waived any year with $100,000+ spend)',
        '$1,000 bonus after $15,000 spend in first 90 days',
        '10% Loyalty Cash Bonus when rewards redeemed to ACME Financial business deposit account',
      ...
      keyDetail: '$1,000 bonus · 10% loyalty bonus to ACME Financial deposit · $299 annual fee',
      applyUrl: 'https://appointments.acmefinancial.com/schedule', // appointment-based
    },
    {
      id: 'travel-card',
      name: 'ACME Financial Business Travel Card',
      category: 'credit_cards',
      ...
      applyUrl: 'https://businesscreditcard.digitalcommerce.acmefinancial.com/product/SBT',
    },
    {
      id: 'business-card',
      name: 'ACME Financial Business Starter Card',
      category: 'credit_cards',
      tagline: 'No-frills card with the lowest rate of all ACME Financial business card options.',
      features: [
        'No annual fee',
        '0% intro APR on purchases for 12 months after account opening',
        '13.74%–22.74% variable APR after intro period (lowest among ACME Financial business cards)',
        'Best for cost-conscious businesses that prioritize a lower ongoing rate',
        'Employee cards available',
      ],
      keyDetail: 'No annual fee · Lowest APR · 0% intro 12 mo.',
      applyUrl: 'https://businesscreditcard.digitalcommerce.acmefinancial.com/product/SBL',
    },
  ],
  ...
  loans: [
    {
      ...
      features: [
        ...
        'Business Advantage Checking clients may qualify for 0.25%–0.50% rate discount',
      ],
      keyDetail: 'Up to $50K · No collateral · No origination fee · Up to 60 mo.',
      applyUrl: 'https://businesslending.digitalcommerce.acmefinancial.com/product/C30',
    },
    {
      id: 'auto-loan',
      name: 'Business Auto Finance',
      category: 'loans',
    ...
    {
      id: 'equipment-loan',
      name: 'Business Equipment Finance',
      category: 'loans',
    ...
    {
      id: 'real-estate-loan',
      name: 'Business Real Estate Finance',
      category: 'loans',
  ...
  line_of_credit: [
    {
      ...
      applyUrl: 'https://businesslending.digitalcommerce.acmefinancial.com/product/C31',
    },
  ],
  ...
  digital_services: [
    {
      id: 'online-banking',
      name: 'ACME Financial Business Online Banking',
      ...
      features: [
        ...
        'Mobile check deposit via ACME Financial app',
      ...
      applyUrl: 'https://bank.acmefinancial.com/web/enroll/business',
    },
    {
      id: 'online-payroll',
      name: 'ACME PayHub',
      ...
      features: [
        ...
        'Requires ACME Financial Small Business checking account and online banking enrollment',
      ...
      applyUrl: 'https://bank.acmefinancial.com/',
    },
  ],
 ...
 */
const ACME_SB_PRODUCTS_FLAT = Object.values(ACME_SB_PRODUCTS).flat();

/**
 * Category metadata — display labels and sort order
 */
const ACME_SB_CATEGORIES = [
